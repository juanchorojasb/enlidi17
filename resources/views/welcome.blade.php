                ...
                <div class="col-span-1 lg:col-span-3">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div class="flex items-center mt-4">
                            <img src="{{ asset('assets/images/team2.jpg') }}" alt="Lorena García" class="w-12 h-12 rounded-full mr-4">
                            <div>
