    ...
    <nav x-data="{ open: false }" class="bg-primary border-b border-gray-100">
            ...
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center">
                    ...
                    <nav class="hidden sm:flex space-x-8 sm:-my-px sm:ms-10">
                        <x-nav-link :href="route('user.dashboard')" :active="request()->routeIs('user.dashboard')" class="text-white hover:text-gray-200">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                        <x-nav-link :href="route('user.projects.index')" :active="request()->routeIs('user.projects.index')" class="text-white hover:text-gray-200">
                            {{ __('Proyectos') }}
                        </x-nav-link>
                        <x-nav-link :href="route('user.documents.index')" :active="request()->routeIs('user.documents.index')" class="text-white hover:text-gray-200">
                            {{ __('Documentos') }}
                        </x-nav-link>
                    </nav>
                </div>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-primary">
            <div class="pt-2 pb-3 space-y-1">
                @auth
                    <x-responsive-nav-link :href="route('user.dashboard')" :active="request()->routeIs('user.dashboard')" class="text-white hover:text-gray-200">
                        {{ __('Dashboard') }}
                    </x-responsive-nav-link>
                @endauth
                <x-responsive-nav-link :href="route('user.projects.index')" :active="request()->routeIs('user.projects.index')" class="text-white hover:text-gray-200">
                    {{ __('Proyectos') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('user.documents.index')" :active="request()->routeIs('user.documents.index')" class="text-white hover:text-gray-200">
                    {{ __('Documentos') }}
                </x-responsive-nav-link>
                <x-responsive<x-responsive-nav-link :href="route('about')" :active="request()->routeIs('about')" class="text-white hover:text-gray-200">
                    {{ __('About') }}
                </x-responsive-nav-link>
