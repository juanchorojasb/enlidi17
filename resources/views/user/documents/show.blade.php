...
<div class="container mx-auto p-4">
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mt-6">
            <a href="{{ Storage::url($document->file_path) }}" target="_blank" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Ver Documento</a>
            ...
            <a href="{{ route('projects.show', $document->project->id) }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Volver al Proyecto</a>
        </div>
    </div>
</div>
@endsection