...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <div class="mb-4">
          <a href="{{ route('documents.create') }}" class="bg-primary hover:bg-primary-dark text-white font-bold py-2 px-4 rounded-md inline-flex items-center">
                    ...
                    <tbody>
                        @foreach($documents as $document)
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="py-2 px-4 border-b">
                                    <a href="{{ route('documents.show', $document) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md text-xs inline-flex items-center mr-1">
                                        <i class="fa fa-eye mr-1"></i> Ver
                                    </a>
                                    <a href="{{ route('documents.edit', $document) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded-md text-xs inline-flex items-center mr-1">
                            ...
                            <tr class="hover:bg-gray-100">
                                <td colspan="4" class="py-2 px-4 border-b">
                                    ...
                                    @else
                                        <p class="text-gray-600">Previsualización no disponible. <a href="{{ Storage::disk('public')->url($document->file_path) }}" class="text-primary hover:underline" download>Descargar archivo</a>.</p>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
