        ...
        <div class="w-full max-w-md">
            <div class="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
                <div class="text-center mb-6">
                    <h1 class="text-gray-700 text-2xl font-bold"><?php echo e(__('Login')); ?></h1>
                </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        <div class="flex items-center">
                            <input class="form-checkbox h-4 w-4 text-indigo-600 transition duration-150 ease-in-out" type="checkbox" name="remember" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                            <label class="ml-2 block text-gray-700 text-sm font-bold" for="remember">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\enlidi17\resources\views/auth/login.blade.php ENDPATH**/ ?>