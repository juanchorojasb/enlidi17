...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'projects'], function() {
        ...
        // Stages (anidadas a proyectos)
        Route::resource('/{project}/stages', StageController::class)->shallow();
    });

    // Documents (anidadas a etapas)
    Route::resource('stages.documents', DocumentController::class)->shallow();
    Route::get('/stages/{stage}/documents/{document}/download', [DocumentController::class, 'download'])->name('documents.download');
